...
CREATE TABLE education_degrees (
    ...
    name varchar(50) NOT NULL,
    CONSTRAINT education_degrees_pk PRIMARY KEY (education_degree_id)
);
...
CREATE TABLE occupations (
    ...
    name varchar(50) NOT NULL,
    CONSTRAINT occupations_pk PRIMARY KEY (occupation_id)
);
...
CREATE TABLE parents_information (
    ...
    religions_religion_id int NOT NULL,
...
) COMMENT 'Clase de un curso dictada por un profesor a un determinado horario';
...
ALTER TABLE debts ADD CONSTRAINT debts_payments FOREIGN KEY debts_payments (payment_id)
    REFERENCES payments (payment_id);

-- Reference: debts_transactions (table: debts)
ALTER TABLE debts ADD CONSTRAINT debts_transactions FOREIGN KEY debts_transactions (transaction_id)
...
ALTER TABLE enrollments_form ADD CONSTRAINT ef_first_language FOREIGN KEY ef_first_language (second_language)
    REFERENCES languages (language_id);

-- Reference: ef_second_language (table: enrollments_form)
ALTER TABLE enrollments_form ADD CONSTRAINT ef_second_language FOREIGN KEY ef_second_language (mother_tongue)
    REFERENCES languages (language_id);
...
ALTER TABLE enrollments_form ADD CONSTRAINT enrollments_form_districts FOREIGN KEY enrollments_form_districts (district_id)
    REFERENCES districts (district_id);

-- Reference: enrollments_form_religions (table: enrollments_form)
ALTER TABLE enrollments_form ADD CONSTRAINT enrollments_form_religions FOREIGN KEY enrollments_form_religions (religion_id)
    REFERENCES religions (religion_id);

-- Reference: enrollments_form_students (table: enrollments_form)
ALTER TABLE enrollments_form ADD CONSTRAINT enrollments_form_students FOREIGN KEY enrollments_form_students (enrollment_form_id)
    REFERENCES students (student_id);

-- Reference: enrollments_form_type_of_birth (table: enrollments_form)
ALTER TABLE enrollments_form ADD CONSTRAINT enrollments_form_type_of_birth FOREIGN KEY enrollments_form_type_of_birth (tipe_of_birth_id)
    REFERENCES types_of_birth (tipe_of_birth_id);

-- Reference: enrollments_grades (table: enrollments)
ALTER TABLE enrollments ADD CONSTRAINT enrollments_grades FOREIGN KEY enrollments_grades (grade_id)
    REFERENCES grades (grade_id);

-- Reference: enrollments_scholarships (table: enrollments)
ALTER TABLE enrollments ADD CONSTRAINT enrollments_scholarships FOREIGN KEY enrollments_scholarships (scholarship_id)
...
ALTER TABLE enrollments ADD CONSTRAINT enrollments_states FOREIGN KEY enrollments_states (state_id)
...
ALTER TABLE parent_by_student ADD CONSTRAINT parent_by_student_ef FOREIGN KEY parent_by_student_ef (enrollment_form_id)
    REFERENCES enrollments_form (enrollment_form_id);

-- Reference: parent_by_student_pi (table: parent_by_student)
ALTER TABLE parent_by_student ADD CONSTRAINT parent_by_student_pi FOREIGN KEY parent_by_student_pi (parent_information_id)
...
-- Reference: parents_information_education_degrees (table: parents_information)
ALTER TABLE parents_information ADD CONSTRAINT parents_information_education_degrees FOREIGN KEY parents_information_education_degrees (education_degree_id)
    REFERENCES education_degrees (education_degree_id);

-- Reference: parents_information_occupations (table: parents_information)
ALTER TABLE parents_information ADD CONSTRAINT parents_information_occupations FOREIGN KEY parents_information_occupations (occupation_id)
    REFERENCES occupations (occupation_id);

-- Reference: parents_information_religions (table: parents_information)
ALTER TABLE parents_information ADD CONSTRAINT parents_information_religions FOREIGN KEY parents_information_religions (religions_religion_id)
    REFERENCES religions (religion_id);

-- Reference: payment_discounts_payments (table: payment_discounts)
ALTER TABLE payment_discounts ADD CONSTRAINT payment_discounts_payments FOREIGN KEY payment_discounts_payments (payment_id)
    REFERENCES payments (payment_id);

-- Reference: payments_payment_types (table: payments)
ALTER TABLE payments ADD CONSTRAINT payments_payment_types FOREIGN KEY payments_payment_types (payment_type_id)
    REFERENCES payment_types (payment_type_id);

-- Reference: pi_document_types (table: parents_information)
ALTER TABLE parents_information ADD CONSTRAINT pi_document_types FOREIGN KEY pi_document_types (document_type_id)
...
ALTER TABLE students_disabilities ADD CONSTRAINT sd_td FOREIGN KEY sd_td (type_disabiltiy_id)
    REFERENCES types_disabilities (type_disabilty_id);

-- Reference: sds_ef (table: students_disabilities)
ALTER TABLE students_disabilities ADD CONSTRAINT sds_ef FOREIGN KEY sds_ef (enrollment_form_id)
    REFERENCES enrollments_form (enrollment_form_id);
...
ALTER TABLE students ADD CONSTRAINT students_grades FOREIGN KEY students_grades (last_grade_id)
    REFERENCES grades (grade_id);
...
ALTER TABLE students ADD CONSTRAINT students_relationships FOREIGN KEY students_relationships (relationship_id)
...
ALTER TABLE transactions ADD CONSTRAINT transactions_enrollments FOREIGN KEY transactions_enrollments (enrollment_id)
    REFERENCES enrollments (enrollment_id);

-- Reference: transactions_school (table: transactions)
ALTER TABLE transactions ADD CONSTRAINT transactions_school FOREIGN KEY transactions_school (school_ruc)
    REFERENCES school (ruc);

-- Reference: transactions_states (table: transactions)
ALTER TABLE transactions ADD CONSTRAINT transactions_states FOREIGN KEY transactions_states (state_id)
    REFERENCES states (state_id);
...
ALTER TABLE users ADD CONSTRAINT users_genders FOREIGN KEY users_genders (gender_id)
