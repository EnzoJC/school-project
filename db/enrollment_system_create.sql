...
(
    ...
    CONSTRAINT debts_pk PRIMARY KEY (payment_id, transaction_id)
);
...
-- Reference: enrollments_form_blood_types (table: enrollments_form)
ALTER TABLE enrollments_form
    ADD CONSTRAINT enrollments_form_blood_types FOREIGN KEY enrollments_form_blood_types (blood_type_id)
...
ALTER TABLE parents_information
    ADD CONSTRAINT parents_information_education_degrees FOREIGN KEY parents_information_education_degrees (education_degree_id)
        REFERENCES education_degrees (education_degree_id);

-- Reference: parents_information_occupations (table: parents_information)
ALTER TABLE parents_information
    ADD CONSTRAINT parents_information_occupations FOREIGN KEY parents_information_occupations (occupation_id)
        REFERENCES occupations (occupation_id);

-- Reference: parents_information_religions (table: parents_information)
ALTER TABLE parents_information
    ADD CONSTRAINT parents_information_religions FOREIGN KEY parents_information_religions (religions_religion_id)
        REFERENCES religions (religion_id);
...
BEGIN
    START TRANSACTION;
    INSERT INTO increment_transaction VALUES (NULL);
